...
- "Open an existing workspace" flow: point the app at a folder previously generated by workspace-kit (or any folder following the same conventions) and see a read-only summary — which of PROJECT/DECISIONS/CONTEXT/TASKS/CLAUDE/AGENTS/etc. exist, kit, last-modified dates.
