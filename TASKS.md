...
- [ ] Propagate the 2026-07-26 positioning + "kits" rename decision (see DECISIONS.md) into CONTEXT.md's vocabulary section — PROJECT.md and docs/PRD.md were updated 2026-07-27; CONTEXT.md still uses "project type" as the term of art
