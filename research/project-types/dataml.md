# Project type — Data / ML pipeline (`dataml`)
...
- This is one of the types most likely to actually need a `.gitignore` — directly relevant to the open TASKS.md item about generating a `.gitignore` per project type.
